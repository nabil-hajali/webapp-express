...
This is an express API server for the movies review app, it exposes the following endpoints:
-home: GET '/'
-movies: GET '/movies' index
-movies: GET '/movies/:id' show
-movies: movie review endpoint?